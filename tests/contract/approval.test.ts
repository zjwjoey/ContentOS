...
const pending: ApprovalDecisionV0 = { schemaVersion: 'APPROVAL_V0', projectId: 'project-approval', targetType: 'PUBLISH', targetId: 'publisher-request-1', targetRevisionId: 'publisher-revision-1', status: 'PENDING', approver: 'operator-1', evidence: { titleChecked: true } };
