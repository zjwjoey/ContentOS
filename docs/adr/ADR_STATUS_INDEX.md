...
| ADR-014 | Review Analytics V1 Through Public ExternalPost Port   | Accepted with Conditions | Fake/Import rollout only; real platform metrics require a later adapter review                                              |
...
`Accepted: 7` · `Accepted with Conditions: 8` · `Proposed: 0` · `Rejected: 0` · `Superseded: 0`.
