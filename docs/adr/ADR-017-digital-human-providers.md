...
- Preserve idempotent reads for existing active or successful Avatar Generations even when a later Provider capability check is unavailable; only new requests and terminal retries require a fresh preflight.
