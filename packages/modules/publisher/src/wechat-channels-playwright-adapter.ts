...
export class WeChatChannelsPlaywrightAdapter implements PublisherAdapter {
  ...
  private stateKey(context: PublisherContext, idempotencyKey: string): PublishStateKey { return { platformId: 'wechat-channels', accountId: context.accountId, idempotencyKey }; }
}
