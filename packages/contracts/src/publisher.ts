...
export interface PublisherRequestRevision { id: string; requestId: string; revision: number; assetId: string; assetChecksum: string; title: string; description: string; desiredPublishAt: string | null; createdBy: string; createdAt: string; }
