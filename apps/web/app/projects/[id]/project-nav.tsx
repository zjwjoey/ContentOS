...
export function ProjectNav({ projectId, currentStage }: { projectId: string; currentStage?: ProductStageKey | null }) {
  const labels: Record<string, string> = { ASSETS: '素材库', DIRECTOR: '内容策划', BENCHMARK: '对标分析', VIDEO: '视频剪辑', APPROVALS: '审批', PUBLISHER: '发布', REVIEW: '复盘分析' };
